$(document).ready(function () {
	...
	if (rol_id == 1) {
		$("#tabla_troqueladora tbody tr").dblclick(function () {
	...
	$(".cambiar_estado").click(function (e) {//ESTAO DEL REPORTE
		...
		toastr["success"]('El reporte fue modificado')
	...
	/* 	var filas = $("table#tabla_troqueladoras tr").first()
		console.log(filas);
