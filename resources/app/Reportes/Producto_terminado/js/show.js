	...
	$(document).on("click", "#tabla_producto_terminado tbody tr button#btn_modificar_proceso", function () {
		$.ajax({
			...
			success: function (response) {
				...
				//datos[0].estado == "Aprobado" ? document.getElementById("lista_de_etiquetas").style.display = "" : "";
				...
				//datos[0].estado == "Abierto" ? document.getElementById("lista_de_etiquetas").style.display = "none" : "";
				...
				//datos[0].estado == "Transferido" ? document.getElementById("lista_de_etiquetas").style.display = "none" : "";
				...
				//datos[0].estado == "Rechazado" ? document.getElementById("lista_de_etiquetas").style.display = "none" : "";
