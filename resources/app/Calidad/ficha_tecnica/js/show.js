			...
			columns: [
				...
				},
				{
					...
					render: function (ruta) {
						return (
							`<td>
								<a type="button" class="btn ver_ficha botones" target="_blank" href = "ficha_tecnica/fichas/`+ruta +`">
									<img src="/Produccion/resources/img/Ver.png">
								</a>
								
								<button `+(rol_id == 6 ? '' : rol_id == 1 ? '':'disabled') +` class="eliminar btn btn-danger botones" id="`+ruta +`"><img src="/Produccion/resources/img/Eliminar.png" alt=""></button>
							</td>`
						);
					},
				},
