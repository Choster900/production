$(document).ready(function () {
	...
	// IMAGEN //
	$("input.upload_ficha_pegadora").on("input", function (e) {
		var codigo = $(this).attr("name"); // esto es un numero entero por ejemplo //15
		var campo = $(this).attr("id"); // campo a modificar por ejemplo nombre
		...
		$.ajax({
			type: "POST",
			url: base_url + "calidad/ficha_tecnica/guardar_archivo_pegadora",
			data: data,
			processData: false,
        	contentType: false,
			success: function (response) {
	...
	// PDF //
	$("input.uploadPDF_ficha_pegadora").on("input", function (e) {
		var codigo = $(this).attr("name"); // esto es un numero entero por ejemplo //15
		var campo = $(this).attr("id"); // campo a modificar por ejemplo nombre
		var file = e.target.files[0]; //
		...
		$.ajax({
			type: "POST",
			url: base_url + "calidad/ficha_tecnica/guardar_archivoPDF_pegadora",
			data: data,
			processData: false,
        	contentType: false,
			success: function (response) {
	...
	$("input.upload_nombre_archivo").on("input", function (e) {
		...
		$.ajax({
			type: "POST",
			url: base_url + "calidad/ficha_tecnica/guardar_nombre_archivo_pegadora",
			data: data,
			success: function (response) {
				console.log(response);
			},
