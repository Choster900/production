            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control" type="text" id="codigo_operador" data-validetta="required">
                    </div>
                    <div class="form-group">
                        <label for="nombre_operador">Nombre</label>
                        <input class="form-control form-control" type="text" id="nombre_operador" data-validetta="required">
                    </div>
                    <div class="form-group">
                        <label for="nombre_corto_operador">Nombre Corto</label>
                        <input class="form-control form-control" type="text" id="nombre_corto_operador" data-validetta="required">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-select-basic-singles-catalogos" id="usuario" data-validetta="required">
                            <option value=""></option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-select-basic-singles-catalogos" id="zona" data-validetta="required">
                            <option value=""></option>
...
<script src="<?php echo base_url("resources/app/catalogo/operadores/js/show.js"); ?>"></script>