            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <div class="form-group">
                        <label for="tipo">Seleccione la famialia de maquinas</label>
                        <select class="js-select-basic-singles-catalogos" id="tipo" data-validetta="required">
                            ...
                            <option value="operaciones_impresoras">Impresoras</option>
                            <option value="operaciones_troqueladoras">Troqueladoras</option>
                            <option value="operaciones_pegadoras">Pegadoras</option>
                            <option value="operaciones_flexografia">Flexografia</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <form action="" method="POST" id="maquinas" data-table="maquinas" data-id="">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="codigo_operaciones">Código</label>
                        <input class="form-control form-control" type="text" id="codigo_operaciones" data-validetta="required">
                    </div>
                    <div class="form-group">
                        <label for="nombre_operaciones">Nombre</label>
                        <input class="form-control form-control" type="text" id="nombre_operaciones" data-validetta="required">
                    </div>
                </div>
...
<script src="<?php echo base_url("resources/app/catalogo/operaciones/js/show.js"); ?>"></script>