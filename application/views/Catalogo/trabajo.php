<div class="contenedor">
    ...
    <section class="section my-5 pb-5">
        <div class="row gx-5">
            ...
            <div class="col-sm-12 col-lg-8" align='right'> 
                    ...
                    <button id="btnAgregarDocumento" class="btn crear mt-2 mb-2 botones" data-toggle="modal" data-target="#exampleModalLong"  data-backdrop="false">
                        ...
                        <span class="span_boton">Crear Trabajo</span>
                    </button>
        ...
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <table id="tabla_trabajo" class="table table-striped display responsive nowrap text-center p-0 mt-2 tablas_sistema" style="width:100% ">
                    <thead>
                        <tr>
                            <th>Id</th>
                            <th>Descripción</th>
                    ...
                    <thead id="thead_filtros" style="text-align: center;">
                        <tr>
                            ...
                            <th><input type="text" class="tabla input_2" name="descripcion2" id="descripcion2"></th>
    ...
    <div class="modal fade" id="exampleModalLong" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="" method="POST" id="maquinas" data-table="Trabajo" data-id="">
...
<script src="<?php echo base_url("resources/app/catalogo/trabajo/js/show.js"); ?>"></script>