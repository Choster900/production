            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nombre_maquina">Código</label>
                        <input class="form-control form-control" type="text" id="codigo_cierre" data-validetta="required">
                    </div>
                    <div class="form-group">
                        <label for="tipo_maquina">Nombre</label>
                        <input class="form-control form-control" type="text" id="nombre_cierre" data-validetta="required">
                    </div>
                </div>
...
<script src="<?php echo base_url("resources/app/catalogo/cierres/js/show.js"); ?>"></script>