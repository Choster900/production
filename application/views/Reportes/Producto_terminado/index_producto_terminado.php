                ...
                <table id="tabla_producto_terminado" class="table table-striped display responsive nowrap text-center p-0 mt-2 tablas_sistema" style="width:100%; border-collapse: collapse">
                    ...
                    <thead id="thead_filtros" style="text-align: center;">
                        <tr>
                            ...
                            <th>
                                <select class="js-select-basic-single-pt tabla input_12" id="estado" name="estado">
                                    <!-- ESTADO -->
                        ...
                        <div class="text-center ficha-impresora">
                            <?php if ($this->session->userdata("username") == "admin_sergio") { ?>
                                <div class=" row justify-content-center" style="font-size: 10px;--bs-gutter-x: 0rem; padding-bottom: 1.3em;">
                                    ...
                                    <select class="js-select-basic-single-pt areas" id="estado_tabla" name="">
                                        <option value="Abierto">Abierto</option>
                                        <option value="Transferido">Transferido</option>
                                        <option value="Aprobado">Aprobado</option>
                                        <option value="Rechazado">Rechazado</option>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-c-tabs">
                        ...
                        <ul class="nav nav-tabs tabs-2 light-blue darken-3" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#panel17" role="tab"><i class="fa fa-user mr-1"></i> Lista de etiquetas</a>
                            </li>
                        </ul>
                        <!-- Tab panels -->
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade in show active" id="panel17" role="tabpanel">
                                ...
                                <div class="modal-body mb-1">
                                    ...
                                    <table id="" class="table table-striped display responsive nowrap text-center p-0 mt-2 tablas_sistema" style="width:100%; border-collapse: collapse">
                                        <thead>
                                            <tr>
                                                <th style="font-size: 8pt; width:10px;">OT</th>
                                                <th style="font-size: 8pt; width:10px;">CLIENTE</th>
                                                <th style="font-size: 8pt;">FECHA ENTREGA</th>
                                                <th style="font-size: 8pt;">CLIENTE</th>
                                                <th style="font-size: 8pt;">ENCARGADO</th>
