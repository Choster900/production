...
<div class="ficha-pegadora mx-auto container" id="reporteria">
    ...
    <div class="row m-0 p-0 especificaciones">
        ...
        <div class="row m-0 p-0">
            ...
            <div class="col-4">
                COD. PRODUCTO: <input type="text" class="w-50 input_ficha_pegadora" id="cod_producto" name="<?php echo $data[0]->ID ?>" value="<?php echo $data[0]->cod_producto   ?>">
            </div>
        </div>
        <div class="row m-0 p-0">
            <div class="col-4">
    ...
    <table class="table w-100 mt-3">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2">
                <span class="float-start" id="dif">
                        <input class="form-check-input" type="checkbox" role="<?php echo $data[0]->ID ?>" name="pegado_fondo_automatico_disco" value="SI" id="pegado_fondo_automatico_disco" <?php echo ($data[0]->pegado_fondo_automatico_disco == "SI") ? 'checked="checked"' : ' '; ?>>
                        <label class="form-check-label" for="pegado_fondo_automatico_disco" style="color: black;font-size: 10pt">DISCO</label>
                    </span>
                    <span class="float-end" id="dif">
                        <input class="form-check-input" type="checkbox" role="<?php echo $data[0]->ID ?>" name="pegado_fondo_automatico_pistola" value="NO" id="pegado_fondo_automatico_pistola" <?php echo ($data[0]->pegado_fondo_automatico_pistola == "SI") ? 'checked="checked"' : ' '; ?>>
                        <label class="form-check-label" for="pegado_fondo_automatico_pistola" style="color: black;font-size: 10pt">PISTOLA</label>
                    </span>
                <td colspan="2"> Marque la opcion</td>
            </tr>
            </tr>
            ...
            <center>
                <tr>
                    ...
                    <td class="border border-white" colspan="2">
                        <input type="text" class="w-100 input_ficha_pegadora" placeholder="NOMBRE" id="encargados_nombre" name="<?php echo $data[0]->ID ?>" value="<?php echo $data[0]->encargados_nombre  ?>">
                    </td>
...
<table>
    ...
    <div>
        <?php if (isset($documentos_ficha_pegadora[0]->url)) { ?>
            <div class="d-flex justify-content-center">
                <img class="img-fluid" src="<?php echo $documentos_ficha_pegadora[0]->url  ?>" alt="imagen">
            </div>
        <?php } ?>
    </div>
    &nbsp;
    ...
    &nbsp;
    <div>
        <?php if (isset($documentos_ficha_pegadora[0]->pdf)) { ?>
            <div class="d-flex justify-content-center">
                <embed src="<?php echo $documentos_ficha_pegadora[0]->pdf ?>" type="application/pdf" width="100%" height="600px" />
            </div>
        <?php } ?>
    </div>
</table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <?php if (isset($documentos_ficha_pegadora[0]->nombre)) { ?>
                            <input type="text" class="w-100 upload_nombre_archivo" name="<?php echo $documentos_ficha_pegadora[0]->id ?>" id="nombre" value="<?php echo $documentos_ficha_pegadora[0]->nombre ?>" style="margin-bottom: 20px;">
                        <?php } else { ?>
                        ...
                        <?php if (isset($documentos_ficha_pegadora[0]->fecha)) { ?>
                            <input type="date" class="w-100 upload_nombre_archivo" name="<?php echo $documentos_ficha_pegadora[0]->id ?>" id="fecha" value="<?php echo $documentos_ficha_pegadora[0]->fecha ?>" style="margin-bottom: 20px;">
                        <?php } else { ?>
                        ...
                        <?php if (isset($documentos_ficha_pegadora[0]->url)) { ?>
                            <input type="file" class="w-100 upload_ficha_pegadora" name="<?php echo $documentos_ficha_pegadora[0]->id ?>" id="url" value="<?php echo $documentos_ficha_pegadora[0]->url  ?>" style="margin-bottom: 20px;">
                        <?php } else { ?>
                            <input type="file" class="w-100 upload_ficha_pegadora" name="" id="url" value="" style="margin-bottom: 20px;">
                        <?php } ?>

                        <label for="pdf" style="margin-bottom: 10px;">Subir archivo PDF</label>
                       
                        <input type="file" class="w-100 uploadPDF_ficha_pegadora" name="<?php echo $documentos_ficha_pegadora[0]->id ?>" id="pdf" value="<?php echo $documentos_ficha_pegadora[0]->pdf  ?>" style="margin-bottom: 20px;">
