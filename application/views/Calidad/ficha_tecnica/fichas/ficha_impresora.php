...
<div class="ficha-impresora mx-auto container" st id="reporteria">
   ...
   ---------------------ACA SE ESTA TRABAJANDO--------------------
    ...
    <table class="table w-100" id="tabla_imprim">
        <tr class="text-center bg-black text-light;">
        ...
        <tr class="text-center">
            <td colspan="2" rowspan="2" class="pintado" style="width: 200px; padding: 10px;font-size: 5pt;">
                <label class="form-check-label" for="" style="color: black;font-size: 10pt">PASO 1</label> <br> <br>
                &nbsp;
                &nbsp;
                &nbsp;
                &nbsp;
                ...
                &nbsp;
                &nbsp;
                <input class="form-check-input " type="checkbox" name="retiro_paso_1" value="SI" id="retiro_paso_11" role="<?php echo $data[0]->ID ?>" <?php echo ($data[0]->retiro_paso_1 == "SI") ? 'checked="checked"' : ' '; ?>>
                <label class="form-check-label" for="retiro_paso_11" style="color: black;font-size: 7pt">RETIRO</label>
                <!--<input class="form-check-input" type="checkbox" name="paso_1" value="SI" id="paso_11" role="<?php echo $data[0]->ID ?>" <?php echo ($data[0]->paso_1 == "SI") ? 'checked="value"' : ' '; ?>>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_1_1" value="<?php echo $data[0]->variante_flujo_1_1  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_1_1" value="<?php echo $data[0]->rodillo_entintador_1_1  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_1_1" value="<?php echo $data[0]->tomador_tinta_1_1  ?>"></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_1_2" value="<?php echo $data[0]->variante_flujo_1_2  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_1_2" value="<?php echo $data[0]->rodillo_entintador_1_2  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_1_2" value="<?php echo $data[0]->tomador_tinta_1_2  ?>"></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_1_3" value="<?php echo $data[0]->variante_flujo_1_3  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_1_3" value="<?php echo $data[0]->rodillo_entintador_1_3  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_1_3" value="<?php echo $data[0]->tomador_tinta_1_3  ?>"></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_1_4" value="<?php echo $data[0]->variante_flujo_1_4  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_1_4" value="<?php echo $data[0]->rodillo_entintador_1_4  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_1_4" value="<?php echo $data[0]->tomador_tinta_1_4  ?>"></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="presion_5" value="<?php echo $data[0]->presion_5  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_1_5" value="<?php echo $data[0]->variante_flujo_1_5  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_1_5" value="<?php echo $data[0]->rodillo_entintador_1_5  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_1_5" value="<?php echo $data[0]->tomador_tinta_1_5  ?>"></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_1_6" value="<?php echo $data[0]->variante_flujo_1_6  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_1_6" value="<?php echo $data[0]->rodillo_entintador_1_6  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_1_6" value="<?php echo $data[0]->tomador_tinta_1_6  ?>"></td>
        ...
        <?php foreach ($formulacion_imprim as $key => $value) { ?>
            ...
            <tr class="text-center">
                <td colspan="2" rowspan="2" class="pintado" style="width: 200px; padding: 10px;font-size: 5pt;">
                    <label class="form-check-label AutoPasos" for="AutoPaso" id="auto_pasos" style="color: black;font-size: 10pt">PASO</label> <br> <br>
                    &nbsp;
                    &nbsp;
                    &nbsp;
                    &nbsp;
                    &nbsp;
                    <input class="form-check-input formulacion_imprim" type="checkbox" name="<?php echo $value->id_imprim  ?>" id="tiro_paso_11_alt-<?php echo $value->id_imprim  ?>" value="SI" value="<?php echo $value->tiro_paso_1_alt ?>" data-campo="tiro_paso_1_alt" data-referenciaim="formulacion-impris" <?php echo ($value->tiro_paso_1_alt == 'SI') ? "checked" : "" ?>>
                    <label class="form-check-label" for="tiro_paso_11_alt-<?php echo $value->id_imprim  ?>" style="color: black;font-size: 7pt">TIRO</label>
                    &nbsp;
                    &nbsp;
                    &nbsp;
                    &nbsp;
                    &nbsp;
                    <input class="form-check-input formulacion_imprim" type="checkbox" name="<?php echo $value->id_imprim  ?>" id="retiro_11_clon-<?php echo $value->id_imprim  ?>" value="SI" value="<?php echo $value->retiro_1_clon ?>" data-campo="retiro_1_clon" data-referenciaim="formulacion-impris" <?php echo ($value->retiro_1_clon == 'SI') ? "checked" : "" ?>>
                    <label class="form-check-label" for="retiro_11_clon-<?php echo $value->id_imprim  ?>" style="color: black;font-size: 7pt">RETIRO</label>
                </td>
    ...
    <button type="button" id="<?php echo $data[0]->ID ?>" style="float: right;margin-right:-35px;margin-top:-120px; font-size: 12px; color: white;" class="btn btn-git agregar-impresion-cambios botones">+</button>
    ...
    <table class="table w-100" id="tabla_imprim">
        ...
        <tr class="text-center">
            ...
            <td class="pintado" rowspan="2" style="padding: 10px;font-size: 5pt;"><span style="font-size: 8pt;">Presion<br>entintador</span></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="presion_7" value="<?php echo $data[0]->presion_7  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_2_1" value="<?php echo $data[0]->variante_flujo_2_1  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_2_1" value="<?php echo $data[0]->rodillo_entintador_2_1  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_2_1" value="<?php echo $data[0]->tomador_tinta_2_1  ?>"></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="presion_8" value="<?php echo $data[0]->presion_8  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_2_2" value="<?php echo $data[0]->variante_flujo_2_2  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_2_2" value="<?php echo $data[0]->rodillo_entintador_2_2  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_2_2" value="<?php echo $data[0]->tomador_tinta_2_2  ?>"></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="presion_9" value="<?php echo $data[0]->presion_9  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_2_3" value="<?php echo $data[0]->variante_flujo_2_3  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_2_3" value="<?php echo $data[0]->rodillo_entintador_2_3  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_2_3" value="<?php echo $data[0]->tomador_tinta_2_3  ?>"></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="presion_10" value="<?php echo $data[0]->presion_10  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_2_4" value="<?php echo $data[0]->variante_flujo_2_4  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_2_4" value="<?php echo $data[0]->rodillo_entintador_2_4  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_2_4" value="<?php echo $data[0]->tomador_tinta_2_4  ?>"></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="presion_11" value="<?php echo $data[0]->presion_11  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_2_5" value="<?php echo $data[0]->variante_flujo_2_5  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_2_5" value="<?php echo $data[0]->rodillo_entintador_2_5  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_2_5" value="<?php echo $data[0]->tomador_tinta_2_5  ?>"></td>
        ...
        <tr>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="presion_12" value="<?php echo $data[0]->presion_12  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="variante_flujo_2_6" value="<?php echo $data[0]->variante_flujo_2_6  ?>"></td>
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="rodillo_entintador_2_6" value="<?php echo $data[0]->rodillo_entintador_2_6  ?>"></td>
            ...
            <td style="font-size: 7pt; padding: 7px;"><input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="tomador_tinta_2_6" value="<?php echo $data[0]->tomador_tinta_2_6  ?>"></td>
    ...
    <table>
        ...
        <!-- 
            ...
            //////////////////////////////////////////// MODIFICACION A FORMULARIO DE BARNIZ ///////////////////////////////////////////////////////////////////////////
        ...
        <table class="table w-100" id="tabla-subida">
            ...
            -->
            <tr>
                <td colspan="2" class="text-center pintado">PRUEBA DE ROCE</td>
                <td colspan="8">
                    <input type="text" class="w-100 input_ficha_impresora" name="<?php echo $data[0]->ID ?>" id="prueba_rece" value="<?php echo $data[0]->prueba_rece    ?>">
                </td>
                <td colspan="2" class="text-center">
                    <span>Minimo cuatro</span>
                </td>
            </tr>
...
<table>
    ...
    <div>
        <?php if (isset($documentos_ficha_impresora[0]->url)) { ?>
            <div class="d-flex justify-content-center">
                <img class="img-fluid" src="<?php echo $documentos_ficha_impresora[0]->url  ?>" alt="imagen">
            </div>
        <?php } ?>
    </div>
    &nbsp;
    ...
    &nbsp;
    <div>
        <?php if (isset($documentos_ficha_impresora[0]->pdf)) { ?>
            <div class="d-flex justify-content-center">
                <embed src="<?php echo $documentos_ficha_impresora[0]->pdf ?>" type="application/pdf" width="100%" height="600px" />
            </div>
        <?php } ?>
    </div>
</table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <?php if (isset($documentos_ficha_impresora[0]->nombre)) { ?>
                            <input type="text" class="w-100 upload_nombre_archivo" name="<?php echo $documentos_ficha_impresora[0]->id ?>" id="nombre" value="<?php echo $documentos_ficha_impresora[0]->nombre ?>" style="margin-bottom: 20px;">
                        <?php } else { ?>
                        ...
                        <?php if (isset($documentos_ficha_impresora[0]->fecha)) { ?>
                            <input type="date" class="w-100 upload_nombre_archivo" name="<?php echo $documentos_ficha_impresora[0]->id ?>" id="fecha" value="<?php echo $documentos_ficha_impresora[0]->fecha ?>" style="margin-bottom: 20px;">
                        <?php } else { ?>
                        ...
                        <?php if (isset($documentos_ficha_impresora[0]->url)) { ?>
                            <input type="file" class="w-100 upload_ficha_impresora" name="<?php echo $documentos_ficha_impresora[0]->id ?>" id="url" value="<?php echo $documentos_ficha_impresora[0]->url  ?>" style="margin-bottom: 20px;">
                        <?php } else { ?>
                            <input type="file" class="w-100 upload_ficha_impresora" name="" id="url" value="" style="margin-bottom: 20px;">
                        <?php } ?>

                        <label for="pdf" style="margin-bottom: 10px;">Subir archivo PDF</label>
                        <?php if (isset($documentos_ficha_impresora[0]->pdf)) { ?>
                            <input type="file" class="w-100 uploadPDF_ficha_impresora" name="<?php echo $documentos_ficha_impresora[0]->id ?>" id="pdf" value="<?php echo $documentos_ficha_impresora[0]->pdf  ?>" style="margin-bottom: 20px;">
                        <?php } else { ?>
                            <input type="file" class="w-100 uploadPDF_ficha_impresora" name="" id="pdf" value="" style="margin-bottom: 20px;">
                        <?php } ?>
