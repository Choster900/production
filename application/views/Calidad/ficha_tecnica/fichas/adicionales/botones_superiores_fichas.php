<div style="text-align: center;width: 100%;">
        <a id="descargar" class="btn botones" href="<?= base_url() ?>calidad/ficha_tecnica/print/<?php echo $type ?>/<?php echo $data[0]->ID ?>">
            <img src="/Produccion/resources/img/descarga.png" alt="" width="34px" height="29px">
            <span>DESCARGAR</span>
        </a>
        <!-- BOTON PARA SUBIR ARCHIVOS -->
        <button id="subir" class="btn align-middle botones" data-toggle="modal" data-target="#exampleModalLong">
            <img src="/Produccion/resources/img/subir.png" alt="" width="34px" height="29px">
        ...
        <button id="<?= $data[0]->ID ?>" name="<?= $type ?>" class="btn align-middle cerrar_ficha botones">
            <img src="/Produccion/resources/img/enviar.png" alt="" width="34px" height="29px">
            <span>Cerrar</span>
        </button>
</div>
...
<style>
    * {
    ...
    div.ficha-impresora table#tabla_imprim {
        font-size: 10px;
    }
