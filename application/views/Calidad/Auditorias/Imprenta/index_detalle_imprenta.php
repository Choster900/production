                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-12 mb-4">
                        <div class="input-group mb-3">
                            ...
                            <select class="js-select-basic-singles input-tabla-reporte rdo-input" id="slcOperador" style="font-size: 8pt; width: 100px;" data-tabla-name="detalle_fcc011" data-id="" data-name="operador">
                    ...
                    <div class="card">
                        <div class="card-header car-tittle" role="tab" id="headingOne">
                            <a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <h5 class="mb-0" class="title-area">Impresion</h5>
                            </a>
                        </div>
                        ...
                        <!-- Valores de agua por producto inspeccionado -->
                        <div class="card">
                            <div class="card-header car-tittle" role="tab" id="headingTwo">
                                <a class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    <h5 class="mb-0">Valores de agua por producto inspeccionado</h5>
                                </a>
                            </div>

                            <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordionEx">
                                <div class="card-body" id="div-variables-agua"></div>
                            </div>
                        </div>
                        <!-- // Valores de agua por producto inspeccionado  -->
                                ...
                                <div class="card-body">
                                    <div class="card">
                                        ...
                                        <div id="collapseProceso-barniz" class="collapse " role="tabpanel" aria-labelledby="proceso-barniz" data-parent="#accordionExs1">
                                            <div class="row card-body" id="div-proceso-barniz"></div>
                                        </div>
                                        ...
                                        <div id="collapseproducto-barniz" class="collapse " role="tabpanel" aria-labelledby="producto-barniz" data-parent="#accordionExs1">
                                            <div class="row card-body" id="div-producto-barniz"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 mb-4">
                        ...
                        <input type="text" class="form-control rdo-input"  
                                ...
                                id="txtObservaciones" name="" placeholder="Observaciones de Imprenta"
                                 data-tabla-name="detalle_fcc011" data-id="" data-name="observaciones">
                    </div>
...
<script src="<?php echo base_url("resources/app/Calidad/Auditorias/js/Imprenta/show_imprenta.js"); ?>"></script>
<script src="<?php echo base_url("resources/app/Calidad/Auditorias/js/Imprenta/create_imprenta.js"); ?>"></script>
<script src="<?php echo base_url("resources/app/Calidad/Auditorias/js/Imprenta/update_imprenta.js"); ?>"></script>
<script src="<?php echo base_url("resources/app/Calidad/Auditorias/js/Imprenta/trello.js"); ?>"></script>